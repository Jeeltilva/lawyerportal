              ...
              <div class="card-body">
                <form method="POST" action="lawyerdata.jsp" >
                  ...
                  <div class="form-group">
                    ...
                    <input id="email" type="email" class="form-control" name="emailid" required="" >
                  ...
                  <div class="form-group col-6">
                    ...
                    <textarea type = "text" name="address" class="form-control" rows="5" cols="40" placeholder="  Address" required="" ></textarea>
                    </div>
                    <div class="row">
                    <div class="form-group col-6">
                      <label for="council_no">Council No</label>
                      <input id="Council no" type="text" class="form-control" name="councilno" required=""  placeholder=" Council Number">
                    </div>
                    <div class="form-group col-6">
                      <label for="university">University</label>
                      <input id="university" type="text" class="form-control" name="university" required=""  placeholder=" University">
                    </div>
                    </div>
                    <div class="row">
                    <div class="form-group col-6">
                      <label for="year">Experience</label>
                      <input id="year" type="text" class="form-control" name="year" required=""  placeholder=" Experience">
                    </div>
                     
                    </div>
                    	<div class="form-group">
                      <label for="practice">Area of Practice</label><br>
                      	<input type="checkbox" name="prac[]" value="Anticipatory bail"required=""  >
								Anticipatory bail
